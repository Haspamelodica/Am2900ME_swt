 ...
 * <li>condCodeSource = mu, M, I (and a special case: I and M)</li>
 * <li>condCode = the boolean term defining the CT output</li>
 * </ul>
 */
public enum Am2904_Inst implements MuIField {
	LoadM_LoadY_mu_NxorOVRorZ(0_00),
	Set_Set_mu_NxnorOVRornotZ(0_01),
	Swap_Swap_mu_NxorOVR(0_02),
	Reset_Reset_mu_NxnorOVR(0_03),
	Load_LoadForShiftThroughOvr_mu_Z(0_04),
	Load_Invert_mu_notZ(0_05),
	LoadOvrRetain_Load_mu_OVR(0_06),
	LoadOvrRetain_Load_mu_notOVR(0_07),
	ResetZ_LoadCarryInvert_mu_CorZ(0_10),
	SetZ_LoadCarryInvert_mu_notCandnotZ(0_11),
	ResetC_Load_mu_C(0_12),
	SetC_Load_mu_notC(0_13),
	ResetN_Load_mu_notCorZ(0_14),
	SetN_Load_mu_CandnotZ(0_15),
	ResetOvr_Load_IM_NxorN(0_16),
	SetOvr_Load_IM_NxnorN(0_17),
	Load_Load_mu_NxorOVRorZ(0_20),
	Load_Load_mu_NxnorOVRornotZ(0_21),
	Load_Load_mu_NxorOVR(0_22),
	Load_Load_mu_NxnorOVR(0_23),
	Load_Load_mu_Z(0_24),
	Load_Load_mu_notZ(0_25),
	Load_Load_mu_OVR(0_26),
	Load_Load_mu_notOVR(0_27),
	LoadCarryInvert_LoadCarryInvert_mu_CorZ(0_30),
	LoadCarryInvert_LoadCarryInvert_mu_notCandnotZ(0_31),
	Load_Load_mu_C(0_32),
	Load_Load_mu_notC(0_33),
	Load_Load_mu_notCorZ(0_34),
	Load_Load_mu_CandnotZ(0_35),
	Load_Load_mu_N(0_36),
	Load_Load_mu_notN(0_37),
